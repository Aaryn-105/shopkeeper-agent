...
![基于 LangGraph 的问数智能体全流程：关键词抽取、多路召回、合并过滤、生成与校验 SQL 等节点](images/2/2-3-1-1.jpg) s
...
![LangGraph 五件套在电商问数智能体中的位置：StateGraph、State、Node、Edge、Runtime Context 与 Streaming](images/10/10-3-0-1.svg)
